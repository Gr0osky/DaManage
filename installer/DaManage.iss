...
#define FrontendBuildDir "..\\usdm_gui\\build\\windows\\x64\\runner\\Release"
#define BackendDistDir  "..\\usdm-backend\\dist"

[Setup]
; Stable GUID for DaManage installer (do not regenerate unless breaking changes)
...
Source: "..\\Start-DaManage.ps1"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\\Start-DaManage.vbs"; DestDir: "{app}"; Flags: ignoreversion
; Backend single EXE
...
Source: "..\\usdm-backend\\Start-BackendExe.ps1"; DestDir: "{app}\backend"; Flags: ignoreversion
Source: "..\\usdm-backend\\Start-BackendExe.bat"; DestDir: "{app}\backend"; Flags: ignoreversion
Source: "..\\usdm-backend\\Start-BackendExe.vbs"; DestDir: "{app}\backend"; Flags: ignoreversion
